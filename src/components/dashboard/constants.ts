...
export const actionButtonClasses =
  "inline-flex items-center justify-center rounded-xl bg-indigo-600 px-4 py-2 text-sm font-semibold text-white transition cursor-pointer active:bg-indigo-700 active:translate-y-px active:shadow-inner disabled:cursor-not-allowed disabled:opacity-50 dark:bg-indigo-500 dark:active:bg-indigo-600";

export const subtleButtonClasses =
  "inline-flex items-center justify-center rounded-xl border border-slate-200 px-3 py-2 text-sm font-medium text-slate-700 hover:bg-slate-50 transition cursor-pointer disabled:cursor-not-allowed disabled:opacity-60 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-700/50";
